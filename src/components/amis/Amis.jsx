...
function Amis() {
  return<>
        <Navbar/>
        <main className='my-28 mx-5 max-sm:mx-0 md:ml-[14vw]  p-5 max-sm:w-full'>
            ...
            <div  className='flex flex-col w-full'>
                <h1 className=' p-8 text-4xl font-semibold md:mx-44'>Gestion  des amis</h1>
                <ul className='flex mx-52 gap-5 p-6 max-sm:m-0'>
            ...
            <div className='border border-blue-100 flex items-center mx-40 t p-10 max-sm:mx-0'>
